...
namespace Lab3
{
    public static class WMath
    {
        ...
        public static bool RayIntersectsTriangle(FRay ray, Vector3 v1, Vector3 v2, Vector3 v3, bool oneSided, out float intersectionDistance)
        {
            ...
            Vector3 p;
            Vector3.Cross(ray.Direction, e2, out p);
            ...
            {
                Vector3 n;
                Vector3.Cross(e2, e1, out n);
                n.NormalizeFast();

                float dirToTri;
                Vector3.Dot(ray.Direction, n, out dirToTri);
            ...
            Vector3 t;
            Vector3.Subtract(ray.Origin, v1, out t);

            // Calculate 'u' parameter and test bound
            float u;
            Vector3.Dot(t, p, out u);
            u *= inv_det;
            ...
            Vector3 q;
            Vector3.Cross(t, e1, out q);

            // Calculate 'v' parameter and test bound
            float v;
            Vector3.Dot(ray.Direction, q, out v);
            v *= inv_det;
